...
Generated 2026-09-08 08:48 UTC · window 48h · 54 qualified wallets watched · minimum 3 independent backers per signal.

Each signal marks an outcome that several qualified wallets have independently net-bought within the window. Signals are inputs for review, not trade instructions.

## 1. Counter-Strike: Alliance vs FaZe (BO3) - FISSURE PLAYGROUND Group B — **FaZe**

- Score **4.46** · 3 backers · net $44,546 staked
- Backers' average entry 0.72 → current price **0.67** (moved against them -0.06 since entry)
...
- Score **3.93** · 3 backers · net $5,974 staked
...
- Score **2.88** · 3 backers · net $1,700 staked
